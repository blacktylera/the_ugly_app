RSpec.describe User, type: :model do
  describe "validations" do
    ...
    it "should allow valid values for email" do
      should allow_value("tyler@tyler.com", "a@b.co.uk", "tyler+hash@example.com").for(:email)
    end
    describe "should be invalid if email is not formatted correctly" do
      it { should_not allow_value("tyler.com").for(:email) }
      it { should_not allow_value("tyler@examplecom").for(:email) }
